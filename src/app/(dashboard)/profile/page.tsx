...
export default async function ProfilePage() {
  ...
  const goals = Array.isArray(userGoals) ? userGoals.filter((g): g is string => typeof g === 'string') : []

  // Type guard for values
  const topValues = Array.isArray(user.profile?.topValues) ? user.profile.topValues : []
  
  // Type guard for strengths
  const topStrengths = Array.isArray(user.profile?.topStrengths) ? user.profile.topStrengths : []
